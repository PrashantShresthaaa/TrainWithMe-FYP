...
import { Clock, CheckCircle, XCircle, Calendar, Video, MapPin, User, Loader, AlertCircle, Inbox } from 'lucide-react';
...
const TrainerBookingInbox = () => {
  ...
  const [updatingId, setUpdatingId] = useState(null); // tracks which booking is being updated
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 hover:border-gray-200 transition">
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        {/* Status Badge */}
        <span className={`px-3 py-1.5 rounded-lg text-xs font-bold border capitalize ${statusStyles[booking.status]}`}>
          {booking.status}
        </span>
