    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 font-sans">
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        <div className="md:w-1/2 bg-brandBlack p-10 flex flex-col justify-between text-white relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-brandOrange/10 z-0" />

          <div className="relative z-10">
            <h1 className="text-3xl font-bold mb-2">
              Train<span className="text-brandOrange">With</span>Me
            </h1>
          ...
          <div className="relative z-10">
            <h2 className="text-4xl font-bold leading-tight mb-4">
              Focus on your goals,
              <br />
              <span className="text-brandOrange">we handle the rest.</span>
            </h2>
          </div>
        </div>
        ...
        <div className="md:w-1/2 p-10 flex flex-col justify-center">
          ...
          <form className="space-y-5" onSubmit={onSubmit}>
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <a href="#" className="text-xs font-bold text-brandOrange hover:underline">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-brandBlack text-white font-bold py-4 rounded-xl hover:bg-gray-800 transition flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            <span
              ...
              className="text-brandOrange font-bold cursor-pointer hover:underline ml-1"
            >
              Sign Up
            </span>
          </p>
